...
public class Result<T>
{
    ...
    public static Result<T> Success(string message, int statusCode) => new() { IsSuccess = true, Message = message, StatusCode = statusCode };
    ...
    public static Result<T> Success(T data, int statusCode) => new() { IsSuccess = true, Value = data, StatusCode = statusCode };
